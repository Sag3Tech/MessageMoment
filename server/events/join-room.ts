...
import { GenerateUniqueId } from "../utils/participant-id-generator.js";
import { ValidateUniqueUsername } from "../utils/unique-name-validator.js";
import { AssignColorToParticipant } from "../utils/participants-color-handler.js";
  ...
  socket.on(
    ...
    async (roomId: string, username: string, securityCode?: string) => {
      try {
        ...
        const ipDetails = await GetGeoInformation(ip);
